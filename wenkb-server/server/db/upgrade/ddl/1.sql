CREATE TABLE IF NOT EXISTS "t_doc_docmt_info" (
...
CREATE TABLE IF NOT EXISTS "t_doc_docmt_version" (
...
CREATE TABLE IF NOT EXISTS "t_doc_docset_info" (
...
CREATE TABLE IF NOT EXISTS "t_knb_chat_info" (
...
CREATE TABLE IF NOT EXISTS "t_knb_chat_mesg" (
...
CREATE TABLE IF NOT EXISTS "t_knb_dataset" (
...
CREATE TABLE IF NOT EXISTS "t_knb_dataset_chunk" (
...
CREATE TABLE IF NOT EXISTS "t_knb_dataset_ctlg" (
...
CREATE TABLE IF NOT EXISTS "t_knb_dataset_precis" (
...
CREATE TABLE IF NOT EXISTS "t_knb_dataset_triplet" (
...
CREATE TABLE IF NOT EXISTS "t_knb_repos_info" (
  "repos_id" text(32) NOT NULL,
  "repos_nm" text(200),
...
CREATE TABLE IF NOT EXISTS "t_knb_repos_quest" (
...
CREATE TABLE IF NOT EXISTS "t_knb_srch_hist" (
...
CREATE TABLE IF NOT EXISTS "t_sys_model_param" (
...
CREATE TABLE IF NOT EXISTS "t_sys_model_prvd_info" (
  "prvd_id" text(100) NOT NULL,
  "prvd_nm" text(200),
  "prvd_desc" text(2000),
  "prvd_icon" text(1000),
...
CREATE TABLE IF NOT EXISTS "t_sys_model_prvd_modl" (
  "prvd_id" text(100),
  "modl_nm" text(200),
...
CREATE TABLE IF NOT EXISTS "t_sys_model_prvd_param" (
  "prvd_id" text(100) NOT NULL,
  "prm_cd" text(100) NOT NULL,
  "prm_nm" text(200),
  "prm_desc" text(2000),
...
CREATE TABLE IF NOT EXISTS "t_sys_model_setting" (
  "user_id" text(32) NOT NULL,
  "prvd_id" text(100) NOT NULL,
  PRIMARY KEY ("user_id", "prvd_id")
);

CREATE TABLE IF NOT EXISTS "t_sys_schema_version" (
  "version" integer NOT NULL,
  PRIMARY KEY ("version")
);

CREATE TABLE IF NOT EXISTS "t_sys_setting_emrt" (
  "prm_id" text(32) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "t_sys_setting_param" (
  "prm_id" text(32) NOT NULL,
  "prm_cd" text(100),
  "prm_nm" text(200),
  "prm_val" text(2000),
...
CREATE UNIQUE INDEX IF NOT EXISTS "T_SYS_MODEL_PARAM_UNIQUE_INDEX"
